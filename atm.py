"""
 *
 name:  Tapado, Edward Hannes M.
        Capuno, Cedric
        Selda, Jose Mari
 group no.: 5
 program description: An ATM program that lets you LOGIN, DEPOSIT, WITHDRAW, and CHECK BALANCE. 
                        If the user has entered incorrect credentials 3 times consecutively, the login button
                            will be disabled and a pop up message will be shown.
 *
"""
...
class ATM(EasyFrame):
    ...
    def login(self):
        ...
        if self.account:
            ...
            print(f"The login button is clicked {self.count}")
            if self.count >= 3:
